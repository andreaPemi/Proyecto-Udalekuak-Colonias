...
ID_PERSONA_TUTOR NUMBER(5000) PRIMARY KEY, ---REVISAR
ID_PERSONA_MENOR NUMBER(5000) PRIMARY KEY, ---REVISAR
ID_SOLICITUD NUMBER (3000),

CONSTRAINT ID_PERSONA_TUTOR_FK FOREIGN KEY REFERENCES PERSONAS(ID_PERSONA),
CONSTRAINT ID_PERSONA_MENOR_FK FOREIGN KEY REFERENCES PERSONAS(ID_PERSONA),
CONSTRAINT ID_SOLICITUD_FK FOREIGN KEY REFERENCES SOLICITUD(ID_SOLICITUD),
);
